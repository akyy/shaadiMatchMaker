package com.shaadi.match.maker.featureModules.landing.adapters;
...
import com.shaadi.match.maker.databinding.RecyclerAdapterHomeActivityBinding;
import com.shaadi.match.maker.featureModules.landing.models.Location;
import com.shaadi.match.maker.featureModules.landing.models.Name;
...
public class HomeActivityRecyclerAdapter extends RecyclerView.Adapter<HomeActivityRecyclerAdapter.MyViewHolder> {
    ...
    private String formatProfessionalDetails(Location location) {
        ...
        details = "" + location.getStreet().getNumber()+ ", " + location.getStreet().getName() + ", " + location.getCity() + ", " + location.getState()+ ", " + location.getCountry()+ "-" + location.getPostcode();
